...
os.system('xsltproc.exe --nonet --xinclude --stringparam htmlhelp.chm ..\\PluginDoc.chm --stringparam htmlhelp.title "Plugin documentation" --output ..\\Temp\\PluginDoc %s %s'  % (StyleSheet, InFile))
